                    ...
                    <div class="col-md-9">
						...
						<span class="like-btn-text">Like</span> <!-- Default like button text,(Like, wow, sad..) default:Like  -->
						  <ul class="reactions-box"> <!-- Reaction buttons container-->
								<li class="reaction reaction-like" data-reaction="gold"></li>
								<li class="reaction reaction-love" data-reaction="silver"></li>
								<li class="reaction reaction-haha" data-reaction="bronze"></li>
