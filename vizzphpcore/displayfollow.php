            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#watch-history">Followed videos</a></li>
...
$getChannnelDetails = mysql_query("SELECT * FROM uploaded_videos h join follow u on h.`video_id`=u.video_id left join users us on us.id=u.user_id where u.user_id=$user_id LIMIT $start_from, $limit");
...
while ($row = mysql_fetch_assoc($getChannnelDetails)) {
    ...
    ?>
       ...
       <?php
    $limit = 12;
    $sql = mysql_query("SELECT * FROM uploaded_videos h join follow u on h.`video_id`=u.video_id left join users us on us.id=u.user_id where u.user_id=$user_id");
