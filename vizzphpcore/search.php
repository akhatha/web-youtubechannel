            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#watch-history">videos</a></li>
...
$getChannnelDetails = mysql_query("SELECT * FROM uploaded_videos h left join users us on us.id=h.channel_id where  h.video_title LIKE '$keyword%' LIMIT $start_from, $limit");
