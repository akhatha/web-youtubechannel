        	...
        	<div class="row">
                <div class="col-md-12">
                    <ul class="main-category-menu">
                        <li class="color-1"><a href="category.html"><i class="fa fa-music"></i>Music</a></li>
                        <li class="color-2"><a href="category.html"><i class="fa fa-soccer-ball-o"></i>Sports</a></li>
                        <li class="color-3"><a href="category.html"><i class="fa fa-gamepad"></i>Gaming</a></li>
                        <li class="color-4"><a href="category.html"><i class="fa fa-globe"></i>News</a></li>
                        <li class="color-1"><a href="category.html"><i class="fa fa-play-circle-o"></i>Live</a></li>
                        <li class="color-2"><a href="category.html"><i class="fa fa-repeat"></i>360° Video</a></li>
                        <li class="color-3"><a href="category.html"><i class="fa fa-th-large"></i>Template Pages</a>
                        	<ul>
                            	<li><a href="home.html">01-home </a></li>
                            	<li><a href="category.html">02-category </a></li>
                            	<li><a href="category_videos.html">03-category_videos  </a></li>
                            	<li><a href="category_chanels.html">04-category_chanels </a></li>
                            	<li><a href="category_playlists.html">05-category_playlists </a></li>
                            	<li><a href="category_about.html">06-category_about </a></li>
                            	<li><a href="log_in_page.html">07-log_in_page </a></li>
                            	<li><a href="sign_up_page.html">08-sign_up_page </a></li>
                            	<li><a href="watch.html">09-watch </a></li>
                            	<li><a href="upload.html">10-upload </a></li>
                            	<li><a href="blog.html">11-blog </a></li>
                            	<li><a href="single.html">12-single </a></li>
                            	<li><a href="404_page.html">13-404_page </a></li>
                            	<li><a href="history.html">14-history </a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- // col-md-14 -->
        	...
        	<div id="upload">
                <div class="row">
                    ...
                    <div class="col-md-8">
						...
						<form action="{{('videothumbnail')}}" method="post" enctype="multipart/form-data">
                                                     {{ csrf_field() }}
                        	<div class="row">
                            	<div class="col-md-6">
