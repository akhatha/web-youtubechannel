...
<head>
   ...
   <!-- Vendor styles -->
    ...
    <link rel="stylesheet" href="{{url('metisMenu/metisMenu.css')}}" />
    <link rel="stylesheet" href="{{url('metisMenu/animate.css')}}" />
    <link rel="stylesheet" href="{{url('bootstrap/css/bootstrap.css')}}" />

    <!-- App styles -->
    <link rel="stylesheet" href="{{url('font-awesome/css/pe-icon-7-stroke.css')}}" />
